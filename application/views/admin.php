...
<script type='text/javascript'>
    function hapusKategori(id) {
        swal({
                title: 'Apakah anda yakin ingin mengapus kategori?',
    ...
    function hapusPaket(id) {
        swal({
                title: 'Apakah anda yakin ingin mengapus paket?',
...
<div class="container">
    <?php $this->load->view('_partials/menu_admin.php') ?>
    <div class="row">
        ...
        <form action="index.php" method="POST">
            <div class="row">
                <div class="form-group">
                    <div class="col-xs-6">
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios1" value="MHQ_1"
                                   data-toggle="radio" checked="true">
                            MHQ 1 Juz (Juz 1)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios2" value="MHQ_30"
                                   data-toggle="radio">
                            MHQ 1 Juz (Juz 30)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios3" value="MHQ_5 Juz"
                                   data-toggle="radio">
                            MHQ 5 Juz (Juz 1-5)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios4" value="MHQ_10 Juz"
                                   data-toggle="radio">
                            MHQ 10 Juz (Juz 1-10)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios5" value="MHQ_15 Juz"
                                   data-toggle="radio">
                            MHQ 15 Juz (Juz 1-15)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios6" value="MHQ_20 Juz"
                                   data-toggle="radio">
                            MHQ 20 Juz (Juz 1-20)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7" value="MHQ_30 Juz"
                                   data-toggle="radio">
                            MHQ 30 Juz (Juz 1-30)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7" value="Tartil_10 Juz"
                                   data-toggle="radio">
                            Tartil (Juz 1-10)
                        </label>
                        ...
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7"
                                   value="Tilawah Anak-anak_10 Juz" data-toggle="radio">
                    ...
                    <div class="col-xs-6">
                        ...
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7" value="Tilawah Remaja_20 Juz"
                                   data-toggle="radio">
                            Tilawah Remaja (Juz 1-20)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7" value="Tilawah Dewasa_30 Juz"
                                   data-toggle="radio">
                            Tilawah Dewasa (Juz 1-30)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7"
                                   value="Tafsir Bahasa Indonesia_Tafsir" data-toggle="radio">
                            Tafsir Bahasa Indonesia (Juz 1-30)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7"
                                   value="Tafsir Bahasa Arab_Tafsir" data-toggle="radio">
                            Tafsir Bahasa Arab (Juz 1-30)
                        </label>
                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7"
                                   value="Tafsir Bahasa Inggris_Tafsir" data-toggle="radio">
                            Tafsir Bahasa Inggris (Juz 1-30)
                        </label>

                        <label class="radio">
                            <input type="radio" name="optionsRadios" id="optionsRadios7" value="MHQ_Surat"
                                   data-toggle="radio">
                            <select id="kategorisurat" name="kategorisurat" style="min-width:206px"
                                    class="form-control select select-primary" data-toggle="select" required>
                        ...
                        <label class="radio">
                            ...
                            <div class="tagsinput-primary">
                                <input type="text" name="custom" value="" class="tagsinput" data-role="tagsinput"
                                       class="form-control" placeholder="Contoh Juz 1 dan Juz 3 = 1,3"/>
                            </div>
                        </label>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-xs-4" style="padding-bottom: 20px">
                    <select id="surat1" name="surat1" class="form-control select select-default" data-toggle="select"
                            required>
                        <option value="0">Pilih Surah</option>
                        <?php
                        if (isset($where)) {
                ...
                <div class="col-xs-4" style="padding-bottom: 20px; margin-left: 35px">
                    <select id="ayat1" name="ayat1" class="form-control select select-default" data-toggle="select"
                            required>
                        <option value="">Pilih Ayat</option>
                        <?php
                        if (isset($nopaket) && isset($editayat[0])) {
